...
**IMPORTANT** : Met à jour markdownDB.
...
- `/Users/frx33355/Documents/dev/mcp/agents/AGENTS_coding-rules.md` - Regles de coding (testing, etc.)
...
3. **Applique** les regles de coding depuis `agents/AGENTS_coding-rules.md` lors de review/creation de code
4. **Verifie** les versions reelles avant de repondre
5. **Cherche** la documentation localement d'abord
